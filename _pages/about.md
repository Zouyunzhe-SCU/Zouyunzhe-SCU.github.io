...
- **Computer Vision**: Object detection, segmentation, and recognition in medical contexts
- **Medical Image Processing**: Analysis and enhancement of medical imaging modalities (CT, MRI, ultrasound, etc.)
- **Multimodal Medical Large Models**: Integrating multiple data sources for improved clinical decision support
- **Biomedical Signal Processing**: Advanced signal analysis techniques for healthcare applications

## Education

- **M.S. in Electronic Information - Biomedical Engineering**, Sichuan University (2022-Present)
- **B.S. in Medical Informatics Engineering**, [Sichuan University College of Biomedical Engineering](https://bme.scu.edu.cn/)

## Contact

Feel free to reach out to me with any questions or collaboration opportunities:
- **Email**: 2022141500179@stu.scu.edu.cn
- **Affiliation**: [Sichuan University](https://www.scu.edu.cn/), [College of Biomedical Engineering](https://bme.scu.edu.cn/)
